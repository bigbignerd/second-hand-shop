    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="<?=Yii::$app->urlManager->createAbsoluteUrl(['article/index'])?>">
                            <i class="fa fa-circle-o"></i>
                            article list
                        </a>
                    </li>
                    <li>
                        <a href="<?=Yii::$app->urlManager->createAbsoluteUrl(['article/create'])?>">
                            <i class="fa fa-circle-o"></i>
                            article launch
                        </a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="<?=Yii::$app->urlManager->createAbsoluteUrl(['classify/index'])?>">
                            <i class="fa fa-circle-o"></i>
                            classify list
                        </a>
                    </li>
                    <li>
                        <a href="<?=Yii::$app->urlManager->createAbsoluteUrl(['classify/create'])?>">
                            <i class="fa fa-circle-o"></i>
                            add classify
                        </a>
                    </li>
